...
const completeSidebarItems = [
  ...
  },
  {
    ...
    sectionOrder: 2,
    itemOrder: 19,
    icon: { name: "Award", library: "lucide" },
  ...
  },
  {
    ...
    itemOrder: 20,
    icon: { name: "Star", library: "lucide" },
    path: "/admin-dashboard/naac-ratings",
    enabled: true,
  },
  {
    title: "NIRF Ranks",
    ...
    path: "/admin-dashboard/nirf-ranks",
    enabled: true,
  },
  {
    title: "Exam Modes",
    ...
    sectionOrder: 2,
    itemOrder: 22,
    icon: { name: "FileCheck", library: "lucide" },
    path: "/admin-dashboard/exam-modes",
    enabled: true,
  },
  {
    ...
    sectionOrder: 2,
    itemOrder: 23,
    icon: { name: "Laptop", library: "lucide" },
    path: "/admin-dashboard/learning-modes",
    enabled: true,
  },
  {
    ...
    sectionOrder: 2,
    itemOrder: 24,
    icon: { name: "Calendar", library: "lucide" },
    path: "/admin-dashboard/established-years",
    enabled: true,
  },
