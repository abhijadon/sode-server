...
const programsData = [
  ...
  {
    categorySlug: "iim",
    image: "/assets/images/executive-1.png",
    logo: "/assets/images/iim-logo.jpg",
    title: "Executive General Management Program (EGMP)",
    slug: "executive-general-management-program-iim-ahmedabad",
    uniSlug: "iim-ahmedabad",
    description: "Equip yourself with comprehensive general management toolkits, leadership analytics, and business scaling frameworks from IIM Ahmedabad.",
    durSlug: "12-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iim_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iim",
    image: "/assets/images/executive-2.png",
    logo: "/assets/images/iim-logo.jpg",
    title: "Advanced Program in Digital Transformation & AI Strategy",
    slug: "digital-transformation-ai-strategy-iim-bangalore",
    uniSlug: "iim-bangalore",
    description: "Master digital disruption, AI strategy alignment, and cloud governance models for senior tech and product leaders from IIM Bangalore.",
    durSlug: "6-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iim_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iim",
    image: "/assets/images/executive-3.png",
    logo: "/assets/images/iim-logo.jpg",
    title: "Executive Program in Growth Strategies & Corporate Finance",
    slug: "growth-strategies-corporate-finance-iim-calcutta",
    uniSlug: "iim-calcutta",
    description: "Develop corporate financial models, capital allocation strategies, and valuation principles for senior business leaders from IIM Calcutta.",
    durSlug: "12-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iim_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iim",
    image: "/assets/images/executive-4.png",
    logo: "/assets/images/iim-logo.jpg",
    title: "Executive Program in Strategic Management & Leadership",
    slug: "strategic-management-leadership-iim-lucknow",
    uniSlug: "iim-lucknow",
    description: "Enhance high-stakes negotiations, competitive strategy formulation, and leadership presence with IIM Lucknow.",
    durSlug: "9-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iim_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iim",
    image: "/assets/images/executive-5.png",
    logo: "/assets/images/iim-logo.jpg",
    title: "Executive Program in Business Management & Digital Innovation",
    slug: "business-management-digital-innovation-iim-kozhikode",
    uniSlug: "iim-kozhikode",
    description: "Acquire deep expertise in modern digital innovation, business analytics, and strategic transformation from IIM Kozhikode.",
    durSlug: "12-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iim_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iit",
    image: "/assets/images/certification-1.png",
    logo: "/assets/images/iiitb-logo.jpg",
    title: "Executive Certification in Data Science & Machine Learning",
    slug: "data-science-machine-learning-iit-delhi",
    uniSlug: "iit-delhi",
    description: "Deep dive into statistical learning, neural network architectures, and quantitative model optimization with IIT Delhi.",
    durSlug: "9-months",
    elgSlug: "bachelors-or-masters-degree",
  ...
  {
    categorySlug: "iit",
    image: "/assets/images/certification-2.png",
    logo: "/assets/images/iiitb-logo.jpg",
    title: "Executive Certification in AI, Machine Learning & Cloud Computing",
    slug: "ai-ml-cloud-computing-iit-bombay",
    uniSlug: "iit-bombay",
    description: "Advance your technical leadership with cloud architecture, Generative AI models, and machine learning pipelines from IIT Bombay.",
    durSlug: "10-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iiitb_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iit",
    image: "/assets/images/certification-3.png",
    logo: "/assets/images/iiitb-logo.jpg",
    title: "Executive Program in Data Science & Engineering Analytics",
    slug: "data-science-engineering-analytics-iit-madras",
    uniSlug: "iit-madras",
    description: "Acquire expertise in engineering analytics, large-scale data processing systems, and statistical models designed by IIT Madras.",
    durSlug: "12-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iiitb_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iit",
    image: "/assets/images/certification-4.png",
    logo: "/assets/images/iiitb-logo.jpg",
    title: "Executive Program in Cybersecurity & Blockchain Technologies",
    slug: "cybersecurity-blockchain-technologies-iit-kanpur",
    uniSlug: "iit-kanpur",
    description: "Learn advanced penetration testing, cryptographic protocols, ethical hacking, and secure blockchain implementations with IIT Kanpur.",
    durSlug: "8-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iiitb_main_brochure.pdf",
    featured: true,
  ...
  {
    categorySlug: "iit",
    image: "/assets/images/certification-5.png",
    logo: "/assets/images/iiitb-logo.jpg",
    title: "Executive Program in Data Analytics & Applied Finance",
    slug: "data-analytics-applied-finance-iit-roorkee",
    uniSlug: "iit-roorkee",
    description: "Bridge quantitative model building and applied financial analysis to drive algorithmic investment decisions with IIT Roorkee.",
    durSlug: "9-months",
    elgSlug: "bachelors-or-masters-degree",
    brochureUrl: "/assets/pdf/iiitb_main_brochure.pdf",
    featured: true,
